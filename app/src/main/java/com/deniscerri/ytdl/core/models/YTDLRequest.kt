...
class YTDLRequest {
    ...
    /**
     * Returns the URL(s) this request targets, in the order they were given to the constructor.
     * Used by RuntimeManager to separate option flags from the trailing URL argument(s) when
     * bridging to the underlying youtubedl-android library's request format.
     */
