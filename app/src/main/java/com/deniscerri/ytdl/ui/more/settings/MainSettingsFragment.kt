...
class MainSettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        // Always reflect the real build version here instead of a hardcoded string,
        // so it can't drift out of sync with what's actually installed (App Info, APK name, etc.)
        findPreference<Preference>("app_version")?.summary = "VidDown v${BuildConfig.VERSION_NAME}"
