...
object ThemeUtil {
    ...
    fun updateTheme(activity: Activity) {
        ...
        val theme = sharedPreferences.getString("viddown_theme", "System")!!
        when (theme) {
            "Light" -> {
        ...
        val iconMode = sharedPreferences.getString("viddown_icon", "Default")!!
    ...
    fun getStyledAppName(context: Context): Spanned {
        ...
        return "<span  style='color:$hexColor';>VidDown</span> (SAIMUM)"
